...
export default function InnovationTable({ innovations }: ApprovalTableProps) {
        ...
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-sm text-muted-foreground mt-2 max-w-md">
                    There are currently no ideas submitted by you. Submit some ground-breaking ideas.
                </p>
            </div>
        );
    }
                    ...
                    {innovations.map((approval) => (
                        ...
                        >
                            ...
                            <TableCell className="text-center">
                                ...
                                >
                                    <Link href={`/innovations/${approval.idea_id}`}>
                                        View
